...
export const metadata = {
  ...
  alternates: { canonical: "https://webpifyy.vercel.app/image/resizer" },
  ...
  openGraph: {
    ...
    url: "https://webpifyy.vercel.app/image/resizer",
  },
  twitter: {
  ...
  const schema = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        "@id": "https://webpifyy.vercel.app/image/resizer#software",
        "name": "Image Resizer",
        "url": "https://webpifyy.vercel.app/image/resizer",
      ...
      <PageShell>
        ...
        <section className="hubv2-recent">
          <div className="hubv2-recent-hd">
            ...
            <a href="/image/resizer/png" className="hubv2-recent-view-all">Try Resizer →</a>
          </div>
            ...
            <table className="hubv2-recent-table">
              ...
              <tbody>
                <tr className="hubv2-recent-tr">
                  <td className="hubv2-recent-td"><div className="hubv2-recent-file"><div className="hubv2-recent-thumb">🖼️</div><span className="hubv2-recent-filename">cover-photo.jpg</span></div></td>
                  <td className="hubv2-recent-td">4000×3000 → 1920×1080</td>
                  <td className="hubv2-recent-td">5.2 MB</td>
                  <td className="hubv2-recent-td"><span className="hubv2-recent-badge">340 KB (-93%)</span></td>
                  <td className="hubv2-recent-td hubv2-recent-td-right"><a href="/image/resizer/jpeg" className="hubv2-recent-dl">↓</a></td>
                </tr>
                <tr className="hubv2-recent-tr">
                  <td className="hubv2-recent-td"><div className="hubv2-recent-file"><div className="hubv2-recent-thumb">👤</div><span className="hubv2-recent-filename">avatar.png</span></div></td>
                  <td className="hubv2-recent-td">800×800 → 200×200</td>
                  <td className="hubv2-recent-td">420 KB</td>
                  <td className="hubv2-recent-td"><span className="hubv2-recent-badge">28 KB (-93%)</span></td>
                  <td className="hubv2-recent-td hubv2-recent-td-right"><a href="/image/resizer/png" className="hubv2-recent-dl">↓</a></td>
                </tr>
                <tr className="hubv2-recent-tr">
                  <td className="hubv2-recent-td"><div className="hubv2-recent-file"><div className="hubv2-recent-thumb">🎨</div><span className="hubv2-recent-filename">banner.webp</span></div></td>
                  <td className="hubv2-recent-td">2400×600 → 1200×300</td>
                  <td className="hubv2-recent-td">890 KB</td>
                  <td className="hubv2-recent-td"><span className="hubv2-recent-badge">112 KB (-87%)</span></td>
                  <td className="hubv2-recent-td hubv2-recent-td-right"><a href="/image/resizer/webp" className="hubv2-recent-dl">↓</a></td>
                </tr>
              </tbody>
            </table>
          </div>
