...
export const metadata = {
  ...
  alternates: { canonical: "https://webpifyy.vercel.app/image/remove-background" },
  openGraph: {
    ...
    url: "https://webpifyy.vercel.app/image/remove-background",
  },
};
...
export default function RemoveBackgroundPage() {
  return (
    <PageShell>
      <Breadcrumb items={[{ label: "Home", href: "/" }, { label: "Image", href: "/image" }, { label: "Remove Background" }]} />
      <div className="page-hero">
        <span className="page-badge">✂️ AI</span>
