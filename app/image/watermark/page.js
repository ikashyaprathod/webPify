...
export const metadata = {
  ...
  alternates: { canonical: "https://webpifyy.vercel.app/image/watermark" },
  openGraph: {
    ...
    url: "https://webpifyy.vercel.app/image/watermark",
  },
};
...
export default function WatermarkPage() {
  return (
    <PageShell>
      <Breadcrumb items={[{ label: "Home", href: "/" }, { label: "Image", href: "/image" }, { label: "Add Watermark" }]} />
