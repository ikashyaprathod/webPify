...
export default function PNGCompressorPage() {
  const breadcrumbItems = [
    ...
    { label: "PNG", href: "/image/compress/png" }
  ];
  ...
  const schema = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        "@id": "https://webpifyy.vercel.app/image/compress/png#software",
  ...
  return (
    <>
      ...
      <PageShell>
        <Breadcrumb items={[{label:'Home',href:'/'},{label:'Image Tools',href:'/image'},{label:'Compress',href:'/image/compress'},{label:'PNG'}]} />
