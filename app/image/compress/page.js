...
const cards = [
  ...
  {
    href: "/image/compress/avif",
    icon: "🚀",
    title: "AVIF Compressor",
    desc: "Compress AVIF images — the next-gen format with up to 50% better compression than WebP.",
...
export default function CompressorHubPage() {
  ...
  const schema = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        "@id": "https://webpifyy.vercel.app/image/compress#software",
  ...
  return (
    <>
      ...
      <PageShell>
        <Breadcrumb items={[{label:'Home',href:'/'},{label:'Image Tools',href:'/image'},{label:'Compress'}]} />

        {/* ── Hero ── */}
        <div className="hubv2-hero">
          <span className="hubv2-hero-badge">IMAGE COMPRESSOR</span>
