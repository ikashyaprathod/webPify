...
export default function ImageRotatePage() {
  return (
    <PageShell>
      <Breadcrumb items={[{ label: "Home", href: "/" }, { label: "Image", href: "/image" }, { label: "Rotate & Flip" }]} />
      <div className="page-hero">
        <span className="page-badge">🔄 Rotate & Flip</span>
