    ...
    return (
        <>
                        ...
                        "@graph": [
                            {
                                ...
                                "itemListElement": [
                                    ...
                                    },
                                    {
                                        ...
                                        "position": 3,
                                        "name": "Edit",
                                        "item": "https://webpifyy.vercel.app/image/edit"
                                    },
                                    {
                                        "@type": "ListItem",
                                        "position": 4,
            ...
            <PageShell blob1="#bfdbfe" blob2="#99f6e4">
                <Breadcrumb items={[{label:'Home',href:'/'},{label:'Image Tools',href:'/image'},{label:'Edit',href:'/image/edit'},{label:'Compare'}]} />

                <div className="hubv2-hero">
                    <span className="hubv2-hero-badge">COMPARE</span>
                ...
                <div style={{ display: "flex", gap: "1rem", justifyContent: "center", marginTop: "2.5rem", marginBottom: "2.5rem", flexWrap: "wrap" }}>
                    <Link href="/image/compress" className="comparison-cta">
                        Open Image Compressor
                    </Link>
                    <Link href="/image/convert" className="comparison-cta">
