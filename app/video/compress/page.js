...
export default function VideoCompressorHubPage() {
  ...
  return (
    <>
      ...
      <PageShell>
        <Breadcrumb items={[{label:'Home',href:'/'},{label:'Video Tools',href:'/video'},{label:'Compress'}]} />

        {/* ── Hero ── */}
        <div className="hubv2-hero">
          <span className="hubv2-hero-badge">VIDEO COMPRESSOR</span>
